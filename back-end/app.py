...
@app.route('/coordinatesToCity/<int:latitude>/<int:longitude', method=['GET'])
def getCityFromCoordinates(latitude, longitude):
    return json.dumps(rg.search(latitude, longitude))
